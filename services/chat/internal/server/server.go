// services/chat/internal/server/server.go
package server
...
import (
	...
	"github.com/mohamedfawas/qubool-kallyanam/services/chat/internal/handlers"
)

// Server represents the chat service server
type Server struct {
	cfg     *config.Config
	router  *gin.Engine
...
func (s *Server) registerRoutes() {
	// Create handlers
	healthHandler := handlers.NewHealthHandler(s.mongodb, s.logger)
...
func (s *Server) Start() error {
	...
	go func() {
		s.logger.Info("Starting chat service server",
